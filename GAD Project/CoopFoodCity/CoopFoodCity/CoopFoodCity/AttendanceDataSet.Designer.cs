...
namespace CoopFoodCity {
    ...
    public partial class AttendanceDataSet : global::System.Data.DataSet {
        ...
        public partial class AttendanceDataTable : global::System.Data.TypedTableBase<AttendanceRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AttendanceRow AddAttendanceRow(System.DateTime date, int empid, string schedule) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AttendanceRow FindBydateempid(System.DateTime date, int empid) {
            ...
            private void InitClass() {
                ...
                this.columnschedule.MaxLength = 10;
            }
...
namespace CoopFoodCity.AttendanceDataSetTableAdapters {
    ...
    public partial class AttendanceTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("CONVERT(VARCHAR(10),date,111)", "date");
            tableMapping.ColumnMappings.Add("empid", "empid");
            tableMapping.ColumnMappings.Add("schedule", "schedule");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Attendance] WHERE (([date] = @Original_date) AND ([empid] = @O" +
                "riginal_empid) AND ((@IsNull_schedule = 1 AND [schedule] IS NULL) OR ([schedule]" +
                " = @Original_schedule)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Attendance] ([date], [empid], [schedule]) VALUES (@date, @empi" +
                "d, @schedule);\r\nSELECT date, empid, schedule FROM Attendance WHERE (date = @date" +
                ") AND (empid = @empid)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Attendance] SET [date] = @date, [empid] = @empid, [schedule] = @schedule WHERE (([date] = @Original_date) AND ([empid] = @Original_empid) AND ((@IsNull_schedule = 1 AND [schedule] IS NULL) OR ([schedule] = @Original_schedule)));
SELECT date, empid, schedule FROM Attendance WHERE (date = @date) AND (empid = @empid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CoopFoodCity.Properties.Settings.Default.CoopFoodCityConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT date, empid, schedule FROM dbo.Attendance WHERE empid=@a AND date BETWEEN " +
                "@b AND @c";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@a", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "empid", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int Fill(AttendanceDataSet.AttendanceDataTable dataTable, int a, string b, string c) {
        ...
        public virtual AttendanceDataSet.AttendanceDataTable GetData(int a, string b, string c) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(a));
            if ((b == null)) {
                throw new global::System.ArgumentNullException("b");
        ...
        public virtual int Delete(System.DateTime Original_date, int Original_empid, string Original_schedule) {
            ...
            if ((Original_schedule == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_schedule));
            }
        ...
        public virtual int Insert(System.DateTime date, int empid, string schedule) {
        ...
        public virtual int Update(System.DateTime date, int empid, string schedule, System.DateTime Original_date, int Original_empid, string Original_schedule) {
            ...
            if ((Original_schedule == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_schedule));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string schedule, System.DateTime Original_date, int Original_empid, string Original_schedule) {
            return this.Update(Original_date, Original_empid, schedule, Original_date, Original_empid, Original_schedule);
        }
    }
